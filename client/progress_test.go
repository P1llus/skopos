...
// httptest server. Mirrors examples/post_json_body.yaml: the
...
// timeWindowDoc mirrors examples/post_json_body.yaml: POST with
...
// asyncLatestEventTimestampDoc mirrors examples/async_poll.yaml
